...
✅ Register (if needed) and Sign In to Astra DB [https://astra.datastax.com](https://astra.dev/1-13): You can use your `Github`, `Google` accounts or register with an `email`.
