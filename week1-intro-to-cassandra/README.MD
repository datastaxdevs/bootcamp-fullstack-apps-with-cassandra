...
Welcome to the 'Intro to Cassandra for Developers' workshop! In this two-hour workshop, the Developer Advocate team of DataStax shows the most important fundamentals and basics of the powerful distributed NoSQL database Apache Cassandra. Using Astra DB, a Database-as-a-Service built on Cassandra delivered by DataStax, we will cover the very first steps for every developer who wants to try to learn a new database: creating tables and CRUD operations. 

It doesn't matter if you join our workshop live or you prefer to do at your own pace, we have you covered. In this repository, you'll find everything you need for this workshop:

- [Materials used during presentations](https://github.com/datastaxdevs/bootcamp-fullstack-apps-with-cassandra/raw/main/week1-intro-to-cassandra/slides/WEEK1%20-%20Introduction%20to%20Apache%20Cassandra.pdf)
- [Hands-on exercises](https://github.com/datastaxdevs/bootcamp-fullstack-apps-with-cassandra/tree/main/week1-intro-to-cassandra#table-of-contents)
...
3. Complete DS201 (Cassandra Fundamentals) sections 1 - 8 [HERE](https://academy.datastax.com). 
...
>
> _**Skip** the "Environment Setup" exercise and go right to "Exercise 1 - Install and Start Apache Cassandra". Once there, start at Step 2 "tar -xf dse-> 6.0.0-bin.tar.gz"._
> ```
> docker run -d -t --name class-201 drchung5/ds201
> docker exec -u root -it class-201 bash
> ```
> **_For those doing the exercises skip "exercise 5 - drivers" from the Docker image above. We noticed a set of problems causing frustration with this exercise and we will be covering using the drivers in Java, Python, and JS in the coming weeks._**
...
✅ Register (if needed) and Sign In to Astra DB [https://astra.datastax.com](https://astra.dev/1-6): You can use your `Github`, `Google` accounts or register with an `email`.
